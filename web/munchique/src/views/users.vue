...
<form class="row g-3">
  ...
  <div class="col-md-4">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="validationDefaultUsername"  aria-describedby="inputGroupPrepend2" placeholder="Usuario" required>
    </div>
  </div>
  
  <div class="col-md-3">
    <label for="validationDefault05" class="form-label">Contraseña *</label>
    <input type="Password" class="form-control" id="validationDefault05" placeholder="Contraseña" required>
  </div>
  <div class="col-md-3">
